...
namespace Lightest.Tests.Api.Tests.AssignmentsController
{
    ...
    {
        protected Lightest.Api.Controllers.AssignmentsController _controller
        {
            get
            {
                var controller = new Lightest.Api.Controllers.AssignmentsController(_context,
                    _userManager.Object, _accessServiceMock.Object);
